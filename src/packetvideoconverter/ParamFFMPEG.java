...
public class ParamFFMPEG implements Serializable, Cloneable {
    private static final long SERIAL_VERSION_UID = 2149644430609735448L;
    public static final double MAX_LEN_TRASH_FILE =(double)5;
...
//                System.out.println("!!!!!!!!!!!!!"+r);
    ...
    public static class FileInfo {
        ...
        public FileInfo(ArrayList<String> stream, File source, boolean deleteTrashFile) throws Exception{
            ...
            if (dur.isTrashFile()) {throw new TrashFileException("Файл, длительностью менее "+ParamFFMPEG.MAX_LEN_TRASH_FILE+"сек... удаление! ("+dur.getlenFileWarning()+" сек)",dur.getlenFileWarning(),source);}
            this.title=tit;
            this.duration=dur;
...
//                    inputflag=true;
    ...
    public static class Duration {
        ...
        public Duration(String input, File source, boolean deleteTrashFile) {
            ...
            this.start=strt;
            this.bitrate=btrt;
            this.lenFileWarning=(deleteTrashFile && drtn>0 && drtn<ParamFFMPEG.MAX_LEN_TRASH_FILE)?drtn:(long)-1;
